...
<footer class=" footer bg-gray-900 p-10 font-[sans-serif] tracking-wide">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div class="lg:flex lg:items-center">
          <Link to="/" >
           
            <h1 className="footer-heading">H. RAHIM & CO.</h1>
          </Link>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-4">
            <li>
              <a href="mailto:aziznanded@gmail.com" class="text-gray-300 hover:text-white text-sm">Email</a>
            </li>
            <li>
              <a href="tel:9822416909" class="text-gray-300 hover:text-white text-sm">Phone</a>
            </li>
            <li>
      ...
      <p class='text-gray-300 text-sm mt-10 '>Designed By -<a href='https://instagram.com/majid_hashmi7' target='_blank'
        class="hover:underline   mx-1">@Hashmi Abdul Majid</a>
      </p>
      <div class="border-t text-center border-[#6b5f5f] pt-4  mt-8">
        <p class="text-gray-300 text-[15px]">
          Copyright © 2024
          
          H.RAHIM&CO. All Rights Reserved.
        </p>
      </div>
    </footer>
</>
