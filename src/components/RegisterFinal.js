...
const RegisterFinal = () => {
  ...
  const handlechange = (event) => {
    ...
    if (event.target.value === "" && clickflag) {
          ...
          <form>
            ...
            <div>
              ...
              <div class="flex space-x-4">
                <div class="flex-1">
                  {errors.name ? (
                    ...
                    <label class="text-gray-800 text-sm mb-1 block">Name</label>
                  )}
                  <input
                    name="name"
                    type="text"
                    class={`${
                      flag.name ? "redcol" : ""
                    } text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-3 rounded-md outline-purple-500`}
                ...
                <div class="flex-1">
                  {errors.surname ? (
                    ...
                    <label class="text-gray-800 text-sm mb-1 block">
                      Surname
                    </label>
                  )}
                  <input
              ...
              <div class="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  class="h-4 w-4 shrink-0 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                />
                <label
                  for="remember-me"
            ...
            <div class="!mt-12">
              <button
                onClick={submitform}
                type="button"
                class="w-full py-3 px-4 text-sm tracking-wider font-semibold rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none"
              >
                Create an account
              </button>
            </div>
            <Link to="/login">
              ...
              <p class="text-gray-800 text-sm mt-6 text-center">
                ...
                <a
                  href="javascript:void(0);"
                  class="text-lime-600 font-semibold hover:underline ml-1"
                >
                  Login here
                </a>
              </p>
