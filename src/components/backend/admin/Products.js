...
const Products = () => {
  ...
  function submitted(event) {
    ...
    if (nameRef.current.value && priceRef.current.value && mrpRef.current.value && weightRef.current.value && image1Ref.current.value&& image2Ref.current.value&& image3Ref.current.value&& image4Ref.current.value && descriptionRef.current.value) {
      ...
      <div class="p-4 mx-auto max-w-xl bg-white font-[sans-serif]">
        ...
        <form class="mt-8 space-y-4">
          ...
          <input type='text' ref={weightRef} placeholder='Enter product weight'
            class="w-full rounded-md py-3 px-4 text-gray-800 bg-gray-100 focus:bg-transparent text-sm outline-blue-500" />
             <textarea ref={descriptionRef} placeholder='Enter product Description'
            class="w-full rounded-md py-3 px-4 text-gray-800 bg-gray-100 focus:bg-transparent text-sm outline-blue-500" />
          <input type="text" ref={image1Ref} placeholder='Enter product image url 1' 
            class="w-full rounded-md py-4 px-4 text-gray-800 bg-gray-100 focus:bg-transparent text-sm pt-3 outline-blue-500"/>
            <input type="text" ref={image2Ref} placeholder='Enter product image url 2' 
            class="w-full rounded-md py-4 px-4 text-gray-800 bg-gray-100 focus:bg-transparent text-sm pt-3 outline-blue-500"/>
            <input type="text" ref={image3Ref} placeholder='Enter product image url 3' 
            class="w-full rounded-md py-4 px-4 text-gray-800 bg-gray-100 focus:bg-transparent text-sm pt-3 outline-blue-500"/>
            <input type="text" ref={image4Ref} placeholder='Enter product image url 4' 
            class="w-full rounded-md py-4 px-4 text-gray-800 bg-gray-100 focus:bg-transparent text-sm pt-3 outline-blue-500"/>
          ...
          <table class="min-w-full bg-white">
            ...
            <tbody class="whitespace-nowrap">
              ...
              {product.map((data) => (
                 ...
                 <img className="margin" src={data.image}   key={data.id} onClick={() => handleImageClick(data)}/>
                 </td>
                 <td class="p-4 text-sm text-black">
